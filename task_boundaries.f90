...
use microphysics
use sgs
use params, only: dotracers, dosgs, doMomentumHyperviscosity
use tracers
implicit none
...
if(flag.eq.3) then
  if(doMomentumHyperviscosity) then
    !ghost cells for hyperviscosity
    ...
    call task_exchange(w,dimx1_w,dimx2_w,dimy1_w,dimy2_w,nzm+1,2,2,2,2,3)
  endif
